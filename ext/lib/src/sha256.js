/**
 * sha256.js - HMAC SHA256 functions
 * Copyright (c) 2010 Ookong Ltd. Co. (ookong.com).
 *
 * SYNOPSIS
 *  exports.sha256.hash("abc");               // "ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad"
 *  exports.sha256.hmac("secret key", "abc"); // "549b5df5db986338ab0e122cdba905d12b50aa3a274403c795b6a6c48b7bcb35"
 *
 * DESCRIPTION
 * Borrow from jssha256 version 0.1 (http://point-at-infinity.org/jssha256/)
 */
...
function SHA256_Hash_Byte_Block(H, w) {
  ...
  SHA256_Hash_Word_Block(H, W);
    ...
    S.sha256 = {
        ...
        hash: function(msg, raw) {
            var res;
            SHA256_init();
            SHA256_write(msg);
            res = SHA256_finalize();
            return raw ? array_to_string(res) : array_to_hex_string(res);
        },
        hmac_init: HMAC_SHA256_init,
        hmac_write: HMAC_SHA256_write,
        hmac_finalize: HMAC_SHA256_finalize,
        hmac: function(key, msg, raw) {
            var res;
            HMAC_SHA256_init(key);
            HMAC_SHA256_write(msg);
            res = HMAC_SHA256_finalize();
